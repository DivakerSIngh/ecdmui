...
export class AdminLayoutComponent implements OnInit, OnDestroy {
  ...
  // Demo purposes only
  @HostBinding('class.theme-red') get themeDark() {
    return this.options.theme === 'red';
  }
  @HostBinding('class.theme-acqa') get themeAcqa() {
    return this.options.theme === 'acqa';
  }
  ...
  setTheme(options: AppSettings) {
    this.overlay.getContainerElement().classList.remove('theme-acqa');
    this.overlay.getContainerElement().classList.remove('theme-red');
    if (options.theme === 'red') {
      this.overlay.getContainerElement().classList.add('theme-red');
    }
    else if (options.theme === 'acqa') {
      this.overlay.getContainerElement().classList.add('theme-acqa');
    }
    else {
